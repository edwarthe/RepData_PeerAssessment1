...
plot(min_inter,ave_steps,type="l",xlab="5-minute intervals",ylab="Average steps",main="Average steps per 5-minute intervals")
max<-which.max(ave_steps)
min_interval<-min_inter[max]
average_steps_max<-ave_steps[max][[1]]
```
### 5-minute interval with maximun number of steps on average: `r min_interval`
